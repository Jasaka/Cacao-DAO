...
const features = [
  ...
  {
    title: 'Coordination of resources',
    description:
      "There is no longer a need to switch between different platforms. Coordinate all resources relevent to your project synergistically on CacaoDAO.",
...
export function PrimaryFeatures() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-[#508C56] pt-20 pb-28 sm:py-32"
    >
      <Image
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            ...
            A commonly satisfying consensus can be found.
          </h2>
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            {/*Well everything you need if you aren’t that picky about minor
            details like tax compliance.*/}
            Everything you need to realize the projects you love and others love too.
          </p>
        </div>
        <Tab.Group
          as="div"
