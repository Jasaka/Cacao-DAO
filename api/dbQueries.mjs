...
export const createProposal =
  'INSERT INTO "proposals" (id, title, description, "predictedCost", "currentHash") VALUES ($1, $2, $3, $4, $5) RETURNING *';

export const createProposalFlag =
  'INSERT INTO "proposalFlags" (id, "proposalHash", "flagMessage", "proposalId", "flagAuthorId") VALUES ($1, $2, $3, $4, $5) RETURNING *';
